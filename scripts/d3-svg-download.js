(function() {
  ...
  function download(downloadName) {
    ...
    function getSources(doc, styles) {
      ...
      var append = '\n.svg-crowbar .overlay { cursor: default !important; }';
      styles = styles + append;

      svgs.each(function () {
        var svg = d3.select(this);
        svg.attr("version", "1.1")
          .classed('svg-crowbar', true)
          .insert("defs", ":first-child")
            .attr("class", "svg-crowbar")
          .append("style")
            .attr("type", "text/css").html(styles);
    ...
    function download(source) {
      ...
      var a = d3.select("body")
          .append('a')
          .attr("class", "svg-crowbar")
          .attr("download", downloadName + ".svg")
          .attr("href", url)
          .style("display", "none");
